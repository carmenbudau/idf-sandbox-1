		...
		@Template("<div class='person-cell'>"
				 	+ "<header>"
						...
						+ "<h2>"
							...
							+ "<span class='ein' title='Employer Identification Number'>({15})</span>"
						+ "</h2>"
						+ "<span class='job-title' title='Job Title'>{10}</span> / "
						+ "<span class='department' title='Department'>{14}</span>"
					...
					+ "<section>"
						...
						+ "</div>"
						+ "<aside>"
							+ "<div class='linkedin-skill' title='LinkedIn Skill'><i class='fab fa-linkedin-in'></i> <strong>skill:</strong> {11}</div>"
							+ "<div class='buzzword ' title='Buzzword'><i class='fas fa-comment-dots'></i> {8}</div>"
						+ "</aside>"
						+ "<div class='work'>"
					...
					+ "<footer>"
						+ "<nav class='controls'>"
							+ "<button class='edit' action='{16}' title='Edit'><i class='edit far fa-edit' action='{16}'></i></button>"
							+ "<button class='copy' action='{17}' title='Copy'><i class='copy far fa-copy' action='{17}'></i></button>"
							+ "<button class='delete' action='{18}' title='Delete'><i class='delete far fa-trash-alt' action='{18}'></i></button>"
						+ "</nav>"
					+ "</footer>"
				+ "</div>")
		//@formatter:on
